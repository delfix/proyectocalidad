...
<!--start-home-->
	<div class="head" id="home">
		...
		<div class="wht-head">	
			...
			<li>
                            <a class="scroll" href="../PHP/Usuarios" data-hover="Usuarios">
                                Usuarios
                            </a>
                        </li>
	...
	<div class="clearfix"></div>
	 ...
	 <div class="top-menu">
			...
			<li>
                        ...
                        <li>
                           <a class="scroll" href="" data-hover="Modificar">
                               Modificar
                           </a>
                        </li>
                        <li>
                           <a class="scroll" href="" data-hover="eliminar">
                               Eliminar
                           </a>
                        </li>
				...
				<input type="text" name=municipio" list="combo_tipo">

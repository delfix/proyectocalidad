...
<title>INTERCEL Elimina_Cliente</title>
            ...
            <div class="top-menu">
                <nav>
                    <ul class="cl-effect-16">
                        ...
                        <li><a class="scroll" href="../Productos/Productos.php" data-hover="Productos">Productos</a></li>
                        <li><a class="scroll" href="Ubicacion.php" data-hover="Ubicacion">Ubicacion</a></li>
                    </ul>
                </nav>
            </div>
                <?php
                ...
                try {
                    if (isset($_POST['Delete'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $datos->sql("delete from ubicacion where h_id = ".$id."","Eliminado");
                        echo "<script type='text/javascript'>
                        alert('Elemento Eliminado');
                        </script>";
						$fecha = date("Y-m-d");
$hora  = date("H:i:s"); 
$motivo ="delete en ubicacion ";
...
. "'".$motivo
. "')";
$datos->sql($sql,"Eliminacion Exitoso");
                    }
                    } catch (Exception $e){
                            echo "<script type='text/javascript'>

...
<title>INTERCEL Nuevo_Ubicacion</title>
        ...
        <?php 
                try {
                    if (isset($_POST['Guardar'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $datos->sql("insert into ubicacion (h_nombre, h_descripcion) Values "
                                            . "('$nombre','$descripcion')" ,"Ingreso Exitoso");
...
$datos->sql($sql,"Ingreso Exitoso");
                ...
                ?>
                <form method="post" action="Nuevo_Ubicacion.php" style="float:center;">
                    <br><h4><p> Nombre:</p></h4>

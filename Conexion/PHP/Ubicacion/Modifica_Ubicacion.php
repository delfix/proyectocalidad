...
<title>INTERCEL Modifica_Ubicacion</title>
            ...
            <div class="top-menu">
                ...
                try {
                    if (isset($_POST['Actualizar'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $resultado = $datos->consultar("select * from Ubicacion where h_id = ".$id.""); 
                        if ($resultado){
                            while($row = mysqli_fetch_array($resultado))
                            {
                ?>
                <form method="post" action="Modifica_Ubicacion.php" style="float:center;">
                    <input type="hidden" name="id_update" value="<?php echo $row['h_id'];?>" />
                    <br><h4><p>Nombre:</p></h4>
                    <input type="text" name="nombre" value="<?php echo $row['h_nombre']; ?>">
                    <br><h4><p>Descripcion:</p></h4>
                    <input type="text" name="descripcion" value="<?php echo $row['h_descripcion'];?>">
                    <?php
                            }}
                        ?>
                    <br>
                ...
                <?php
                    ...
                    if (isset($_POST['Modificar'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $datos->sql("update Ubicacion set h_nombre='$nombre', h_descripcion='$descripcion' where h_id='$id_update'"," ");
                        echo "<script type='text/javascript'>
                        alert('Modificacion Exitosa');
                        </script>";
						$fecha = date("Y-m-d");
$hora  = date("H:i:s"); 
$motivo ="Insert en ubicacion ";

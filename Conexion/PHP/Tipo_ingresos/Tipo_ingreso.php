...
<title>INTERCEL Tipo de Ingreso</title>
	...
	<div class="clearfix"></div>
			...
			<div  id="top" class="callbacks_container">
                                    ...
                                    <div class="cuerpo">
                                         <!-- segundo menu -->
	 <div class="top-menu">
                <form method="post" action="Tipo_ingreso.php" style="float:center;">
                                
                                <select name="Buscador">
                                    <option value="tpg.id">Id</option>
                                    <option value="tpg.nombre">Nombre</option>
                                    <option value="tpg.descripción">Descripción</option>
                                    <option value="tpg.monto">Monto</option>
                                </select>
                ...
                <nav>
                    ...
                    <ul class="cl-effect-16">
                        ...
                        <li>
                            <a class="scroll" href="reporte_tpi.php" data-hover="Reporte">
                               Reporte
                                    ...
                                    while($row = mysqli_fetch_array($resultado))
                                        { 
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form method="post" action="Modifica_ingreso.php"">

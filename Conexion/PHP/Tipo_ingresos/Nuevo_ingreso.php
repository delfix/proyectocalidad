...
<title>INTERCEL Gasto_Ingreso</title>
	 ...
	 <div class="top-menu">
			...
			<li>
                    ...
                    if (isset($_POST['Guardar'])) {
                        ...
                        ?>
                               <form method="post" action="Nuevo_ingreso.php" style="float:center;">

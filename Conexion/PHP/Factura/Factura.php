...
<!--start-home-->
	...
	<div class="clearfix"></div>
			...
			<div  id="top" class="callbacks_container">
                                    ...
                                    <div class="cuerpo">
                                         <!-- segundo menu -->
	 <div class="top-menu">
                <form method="post" action="Factura.php" style="float:center;">
                                
                                <select name="Buscador">
                                    <option value="c_nit">NIT</option>
                                    <option value="c_nombre">Nombre</option>
                                    <option value="c_apellido">Apellido</option>
                                </select>
    ...
    $resultado = $datos->consultar("select *  from cliente where ".$buscador." = '".$buscado."'"); 
                     }else {
                                    //$datos->sentencia("insert into categoria (ct_nombre) values ('nueva')","Registro exitoso");
    $resultado = $datos->consultar("select *  from cliente order by c_nombre"); 
                                    //
                    }
                           ?>               
                                    ...
                                    while($row = mysqli_fetch_array($resultado))
                                        { 
                                              ...
                                              <tr>
                                                    ...
                                                    <td >
                                                             <?php echo $row['c_apellido'];?>
                                                    </td>
                                                    
                                                    <td>
                                                        <form method="post" action="File_nueva.php">

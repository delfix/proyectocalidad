...
<title>INTERCEL Nuevo_Municipio</title>
        ...
        <?php 
                try {
                    if (isset($_POST['Guardar'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $datos->sql("insert into municipio (m_departamento,m_nombre, m_descripcion) Values "
                                            . "('$departamento','$nombre','$descripcion')" ,"Ingreso Exitoso");
                ...
                ?>
                <form method="post" action="Nuevo_Municipio.php" style="float:center;">
                    <br>
                    <?php
                        require_once "../../Conexion/Sentencias_sql.php"; 
                        $datos = new Sentencias_sql(); 

...
<title>INTERCEL Departamento</title>
...
<!--start-home-->
	<div class="head" id="home">
        ...
        <!--top-nav-->
            ...
            <!-- segundo menu -->
            <div class="top-menu">
                <form method="post" action="Departamento.php" style="float:center;">
                    <select name="Buscador">
                        <option value="d_id">Codigo</option>
                        <option value="d_nombre">Departamento</option>
                    </select>
                ...
                <nav>
                    <ul class="cl-effect-16">
                        <li><a class="scroll" href="Nuevo_Departamento.php" data-hover="Nuevo">Nuevo</a></li>
                        <li><a class="scroll" href="reporte_Departamento.php" data-hover="Reporte">Reporte</a>
                    </ul>
                </nav>
            </div>
            <?php
                ...
                if (isset($_POST['Buscar'])) {
                    ...
                    $resultado = $datos->consultar("select * from departamento where ".$buscador." = '".$buscado."'"); 
                }
                $resultado = $datos->consultar("select * from Departamento"); 
                ?>
                <table class="width200">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td ><?php echo $row['d_descripcion'];?></td>
                            <td><form method="post" action="Modifica_Departamento.php">
                                <input type="hidden" name="id" value="<?php echo $row['d_id'];?>" />
                                <input type="Submit" name="Actualizar" value="Actualizar">
                                </form></td>
                            <td><form method="post" action="Elimina_Departamento.php">

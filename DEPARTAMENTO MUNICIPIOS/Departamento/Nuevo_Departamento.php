...
<title>INTERCEL Nuevo_Depa</title>
                ...
                <nav>
                    <ul class="cl-effect-16">
                        <li><a class="active scroll" href="../../index.php" data-hover="Inicio">Inicio</a></li>
                         ...
                         <li><a class="scroll" href="Departamento.php" data-hover="Departamento">Departamento</a></li>
        ...
        <?php 
                try {
                    if (isset($_POST['Guardar'])) {
                        ...
                        $datos->conexion();
                        $datos->abrir_bd();
                        $datos->sql("insert into departamento (d_nombre, d_descripcion) Values "
                ...
                ?>
                <form method="post" action="Nuevo_Departamento.php" style="float:center;">
                    <br><h4><p> Nombre:</p></h4>
